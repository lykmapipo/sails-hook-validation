    ...
    validationFields
        .forEach(function(validationField) {
            ...
            if (model._attributes[validationField].columnName) {
                fieldErrors = invalidAttributes[model._attributes[validationField].columnName];
            } else {
                fieldErrors = invalidAttributes[validationField];
            }
                ...
                fieldErrors
                    .forEach(function(fieldError) {
                        ...
                        if (!i18nMessageExist && messages) {
                            //return default error message if user forgot to add custon validation message
